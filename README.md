...
```
### Versão 1.1.0 - 28/07/2020
```
- Colocado comando para sincronizar o relógio de modo estendido.
```
### Versão 1.2.0 - 09/02/2026
```
- Ajustada a estrutura dos comandos que fazem a leitura PAF2.
```
### Versão 1.3.0 - 05/03/2026
```
